...
- [ ] Improve the ingredient manager for super users. The uncategorized ingredients should be searchable. Sub categories should show next to categorised ingredients so I can see at a glance.
