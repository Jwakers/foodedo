 ...
 * Shared by Convex (create/update + migrations) and the Next client (cook mode, editor).
 * Matching uses canonical ingredient docs (aliases, displayName) when available.
 */
