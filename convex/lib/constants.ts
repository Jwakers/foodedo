...
export const MEAL_PLAN_ERRORS = {
  ...
  PREVENT_EDIT_FINALISED_PLAN: "PREVENT_EDIT_FINALISED_PLAN",
} as const;
...
export const RECIPE_AI_HERO_ERRORS = {
  ...
  /** Linked recipe row missing (deleted) while the job was open. */
  RECIPE_NOT_FOUND: "RECIPE_AI_HERO_RECIPE_NOT_FOUND",
