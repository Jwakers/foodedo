...
export const SYSTEM_RECIPES: SystemRecipeSeed[] = [
  ...
  {
    _creationTime: 1771344763633.5332,
    _id: "j97503rgrp508cctnees8vc1pn81ama0",
    category: "dinner",
    complexityTier: "moderate",
    cookTime: 60,
    cuisine: ["other"],
    description:
      "Tender rabbit with carrot and potato in a thyme-scented broth—comforting and filling.",
    image:
      "https://different-cow-771.convex.cloud/api/storage/1f571853-0683-43b7-a433-7e7b35aa1438",
    ingredients: [
      {
        amount: 800,
        name: "rabbit meat",
      ...
      { amount: 500, name: "chicken stock", unit: "ml" },
      { amount: 1, name: "bay leaf", unit: "whole" },
      { amount: 1, name: "thyme", unit: "tbsp" },
      { amount: 2, name: "olive oil", unit: "tbsp" },
    ],
    isGeneratorEligible: true,
    method: [
      ...
      {
        description:
          "Add the rabbit and brown in batches so the pieces colour well—crowding the pan will steam rather than brown. Season with salt and pepper. Return all the rabbit to the pot.",
        title: "Brown the rabbit",
      },
      {
        description:
          "Add the carrots, potatoes, chicken stock, bay leaf, and thyme. Bring to a boil, then reduce the heat, cover, and simmer for 45 minutes until the rabbit is tender and the vegetables are cooked through. Remove the bay leaf. Taste and adjust seasoning. Serve hot, with crusty bread if you like.",
        title: "Simmer and serve",
      },
    ],
    nutrition: {
    ...
    serves: 4,
    source: "system",
    title: "Rabbit Stew with Root Vegetables",
    totalTimeMinutes: 80,
    updatedAt: 1771363894380,
  },
  {
