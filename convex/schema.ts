...
export default defineSchema({
  ...
  recipes: defineTable({
    ...
    .index("by_user_and_primaryProtein", ["userId", "primaryProtein"])
    .index("by_user_and_complexityTier", ["userId", "complexityTier"])
    .index("by_user_updatedAt", ["userId", "updatedAt"])
    .index("by_source", ["source"])
    .index("by_source_and_title", ["source", "title"])
    .index("by_source_and_category", ["source", "category"])
    .index("by_source_and_primaryProtein", ["source", "primaryProtein"])
    .index("by_source_and_complexityTier", ["source", "complexityTier"])
