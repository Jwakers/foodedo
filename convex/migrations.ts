...
/**
 * Internal migrations and maintenance ops. See AGENTS.md for seed, reconcile, system recipe,
 * and reseed workflows. `getRecipeIngredientAssociations` is a read-only report for audits.
 */
